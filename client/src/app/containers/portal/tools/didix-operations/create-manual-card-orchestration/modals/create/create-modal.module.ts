...
import { DidixOperationsCreateManualCardOrchestrationModalComponent } from './create-modal.component';
...
@NgModule({
	...
	declarations: [
		DidixOperationsCreateManualCardOrchestrationModalComponent
	],
	exports: [
		DidixOperationsCreateManualCardOrchestrationModalComponent
	],
...
export class DidixOperationsCreateManualCardOrchestrationModalModule {}
