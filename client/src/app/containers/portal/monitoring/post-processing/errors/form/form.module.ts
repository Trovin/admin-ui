...
import { MonitoringPostProcessingErrorsFormComponent } from './form.component';
...
@NgModule({
	...
	declarations: [
		MonitoringPostProcessingErrorsFormComponent
	],
	exports: [
		MonitoringPostProcessingErrorsFormComponent
	]
...
export class MonitoringPostProcessingErrorsFormModule {}
